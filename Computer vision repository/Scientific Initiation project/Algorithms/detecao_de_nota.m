...
if abs(Resultado1 - Outro1A) <= tolerancia & abs(Resultado2 - Outro2A) <= tolerancia & abs(Resultado3 - Outro3A) <= tolerancia
    f = msgbox('2 reais')
elseif abs(Resultado1 - Outro1B) <= tolerancia & abs(Resultado2 - Outro2B) <= tolerancia & abs(Resultado3 - Outro3B) <= tolerancia
    f = msgbox('5 reais')
else
